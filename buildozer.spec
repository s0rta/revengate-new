...
# (str) Package name
package.name = revengate

# (str) Package domain (needed for android/ios packaging)
package.domain = org.revengate

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (let empty to include all the files)
source.include_exts = py,png,jpg,kv,atlas,ttf,pickle,tml,md,txt,wav
...
version.filename = %(source.dir)s/revengate/__init__.py
